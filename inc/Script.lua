...
if data.username_ then UserNameID = "- 𝑈𝑠𝑒𝑟𝑛𝑎𝑚𝑒 ➣ @"..data.username_.." 𓂅.\n" else UserNameID = "" end
...
'┄─━━◉━━─┄\n'
..'- 𝑌𝑜𝑢𝑟 𝐼𝑑 ➣ '..msg.sender_user_id_..' 𓂅.\n'
..UserNameID
..'- 𝑆𝑡𝑎𝑡𝑠 ➣ '..msg.TheRank..' 𓂅.\n'
..'- 𝐼𝑛𝑡𝑒𝑟𝑎𝑐𝑡𝑖𝑜𝑛 ➣ '..Get_Ttl(msgs)..' 𓂅.\n'
..'- 𝑀𝑠𝑔𝑠 ➣ '..msgs..' 𓂅.\n'
..'- 𝐸𝑑𝑖𝑡 𝑀𝑠𝑔 ➣ '..rfih..' 𓂅.\n'
..'- 𝐺𝑎𝑚𝑒𝑠 ➣ '..zz..' 𓂅.\n'
,dl_cb,nil)
...
'- 𝑌𝑜𝑢 𝑑𝑜𝑛 𝑡 ℎ𝑎𝑣𝑒 𝑝𝑖𝑐𝑡𝑢𝑟𝑒𝑠 𝑖𝑛 𝑦𝑜𝑢𝑟 𝑎𝑐𝑐𝑜𝑢𝑛𝑡 !\n'..'['..UserNameID..']'
..'- 𝑌𝑜𝑢𝑟 𝐼𝑑 ➣ '..msg.sender_user_id_..' 𓂅.\n'
..'- 𝑆𝑡𝑎𝑡𝑠 ➣ '..msg.TheRank..' 𓂅.\n'
..'- 𝐼𝑛𝑡𝑒𝑟𝑎𝑐𝑡𝑖𝑜𝑛 ➣ '..Get_Ttl(msgs)..' 𓂅.\n'
..'- 𝑀𝑠𝑔𝑠 ➣ '..msgs..' 𓂅.\n'
...
return '👨🏾‍🔧¦ اصدار سورس الدولهہ : *v'..version..'* \n📡'
end

if (MsgText[1] == 'تحديث السورس' or MsgText[1] == 'تحديث السورس ™') then
if not msg.SudoBase then return "📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
local GetVerison = https.request('https://ramikong.github.io/rami.github.io/GetVersion.txt') or 0
...
local inline = {{{text="قنآهہ‏‏ آلسـورس : الـزعـيـم 🍃",url="t.me/rambo_syr"}}}
send_key(msg.sender_user_id_,'  [قناة السورس : الـدولهہ](t.me/rambo_syr)',nil,inline,msg.id_)
return false
end
...
if not msg.SudoBase then return"📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
local Get_Files, res = https.request("https://ramikong.github.io/rami.github.io/GetFiles.json")
if res == 200 then
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/ramikong/rami.github.io/master/plugins/"..FileName)
if res == 200 then
...
local inline = {{{text="𝐑𝐀𝐌𝐈 𝐀𝐋 𝐀𝐋𝐈 ༒,☬",url="t.me/"..xsudouser}}}
